...
import tbg_python_copier_template_example

# -- General configuration ------------------------------------------------

# General information about the project.
project = "tbg-python-copier-template-example"

# The full version, including alpha/beta/rc tags.
release = tbg_python_copier_template_example.__version__
...
extensions = [
    ...
    # This can parse google style docstrings and numpy style docstrings
    "sphinx.ext.napoleon",
...
github_repo = "tbg-python-copier-template-example"
